...
Revision ID: 1b960cc77640
Revises: 4b70392c93b6
Create Date: 2024-07-04 22:33:35.267156
...
revision: str = '1b960cc77640'
down_revision: Union[str, None] = '4b70392c93b6'
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('pk_id', name='categoria_pkey'),
    sa.UniqueConstraint('nome', name='categoria_nome_key')
    )
